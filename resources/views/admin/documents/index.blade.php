                ...
                <div class="row pb-10" data-toggle="buttons">
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-20">
                        <div class="select-role">
                            <div class="btn-group btn-group-toggle" >
                                <label class="btn ">
                                    <input type="radio" checked name="type" value="RG"  />
                                    <div class="icon">
                                        <img
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-20">
                        <div class="select-role">
                            <div class="btn-group btn-group-toggle" >
                                <label class="btn">
                                    <input type="radio" name="type" id="type"  value="FP" />
                                    <div class="icon">
                                        <img
                                            src="{{asset('')}}public/vendors/images/briefcase.svg"
                                            class="svg"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-20">
                        <div class="select-role">
                            <div class="btn-group btn-group-toggle" >
                                <label class="btn ">
                                    <input type="radio" name="type" value="NE"  />
                                    <div class="icon">
                                        <img
                                            src="{{asset('')}}public/vendors/images/briefcase.svg"
                                            class="svg"
...
<script src="{{asset('')}}public/{{asset("js/document-init.js")}}"></script>
<script>
$(function () {
    $.ajaxSetup({
        headers: {
...
<script src="{{asset('')}}public/src/plugins/slick/slick.min.js"></script>
<script>
