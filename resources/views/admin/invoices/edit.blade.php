                ...
                <div class="row pb-10">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="pd-20 card-box mb-30">
                            ...
                            <div class="row" id="payment_product">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label>Produto</label>
                                    <select
                        ...
                        <div class="row" id="payment_input">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <label class="col-sm-12 col-md-12 col-form-label">É Produto</label>
...
<script>
    $("#payment").change(function (e) { 
        ...
        $("#payment_product").css("display","block");
        }else{
            $("#payment_input").css("display","block");
        $("#payment_product").css("display","none");
        }
    });
    if ($('#payment').is(':checked')) {
        $("#payment_input").css("display","none");
