    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action=" {{url("packges/".$row->id)}} " method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">  
                                        <select class="form-control" name="stock_type" id="">
                                            <option value=" {{$row->stock_type}} ">-- {{ $L = ($row->stock_type=="L") ? $A=($row->stock_type=="A") ? "Sem Stock" : "Armazém" : "Levantamento" }} -- </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">  
                                        <select class="form-control" name="tax_id" id="">
                                            ...
                                            <option value="ISENTO DE IVA">ISENTO DE IVA</option>
                                        </select>
                                    </div>
                                </div>
