                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{url("providers/create")}}">Gravar</a>
                                <a class="dropdown-item" href="{{url("export/providers")}}">Exportar EXCEL</a>
                                <a class="dropdown-item" href="{{url("import/providers")}}">Importar EXCEL</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <form action="{{ route('providers.destroy',$item->id) }}" method="Post">
                                                <a href="{{ route('providers.edit',$item->id) }}" data-color="#265ed7"><i class="icon-copy fa fa-edit" aria-hidden="true"></i></a>
                                                @csrf
                                                @method('DELETE')
                                                ...
                                                <a href="{{ url("providers/$item->id") }}" data-color="green" ><i class="icon-copy fa fa-user-circle" aria-hidden="true"></i></a>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
