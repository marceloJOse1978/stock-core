...
<head>
  ...
  <title>SETMARK POS</title>
  <link href="{{url("public/css/tailwind.min.css")}}" rel="stylesheet">
  <link rel="stylesheet" href="{{url("public/css/style.css")}}">
  <script src="{{url("public/js/alpine.min.js")}}"></script>
    ...
    <div class="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
      <div class="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
        <a href="{{url("/")}}"
            ...
            <div  width="123.3" height="123.233">
                <img src="{{asset('')}}public/vendors/images/favicon-32x32.png" alt="">
            </div>
        </a>
          ...
          <div class="h-full overflow-y-auto px-2">
            ...
            >
              <div class="w-full text-center">
                ...
                <p class="text-xl">SEU CAIXA ESTÁ FECHADO<br/>OU<br/>SEM PRODUTOS</p>
              </div>
            </div>
            <div
              class="select-none bg-blue-gray-100 rounded-3xl flex flex-wrap content-center justify-center h-full opacity-25"
      ...
      <div class="w-5/12 flex flex-col bg-blue-gray-50 h-full bg-white pr-4 pl-2 py-4">
        <div class="bg-white rounded-3xl flex flex-col h-full shadow">
          ...
          <div class="select-none h-auto w-full text-center pt-3 pb-4 px-4">
            ...
            <div class="flex mb-3 text-lg font-semibold text-blue-gray-700">
              <div>TOTAL</div>
              <div class="text-right w-full" x-text="priceFormat(getTotalTax()+getTotalPrice())"></div>
            </div>
            <div class="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
              <div class="flex text-lg font-semibold">
                <div class="flex-grow text-left">CAIXA</div>
            ...
            >
              <div class="text-cyan-800">TROCO</div>
              <div
    ...
    <div x-show="firstTime" class="fixed glass w-full h-screen left-0 top-0 z-10 flex flex-wrap justify-center content-center p-24">
      <div class="w-96 rounded-3xl p-8 bg-white shadow-xl">
        <div class="text-center">
          <div class="inline-block" width="123.3" height="123.233">
            <img src="{{asset('')}}public/vendors/images/favicon-32x32.png" alt="">
          </div>
          <h3 class="text-center text-2xl mb-8">ABRIR CAIXA ?</h3>
        </div>
        <div class="text-left">
    ...
    >
      ...
      >
        <div id="receipt-content" class="text-left w-full text-sm p-6 overflow-auto">
          ...
          <div class="flex mt-4 text-xs">
            ...
            <div >
              ...
              <table>
                <tr>
                  <td><strong>Comsumidor Final</strong></td>
                </tr>
                <tr>
                  <td>NIF: <strong>XXX XXX XXX</strong></td>
                </tr>
                <tr>
                  <td>CONTACTO: <strong>XXX XXX XXX</strong></td>
                </tr>
                <tr>
                  <td>ENDEREÇO: <strong>XXX XXX XXX</strong></td>
                </tr>
              </table>
            </div>
          </div>
              ...
              <tbody>
                <template x-for="(item, index) in cart" :key="item">
                  <tr>
                    ...
                    <td class="py-2 text-center" x-text="priceFormat(item.qty * item.iva)"></td>
          ...
          <div>
            ...
            <div class="flex font-semibold">
              ...
              <div x-text="priceFormat(getTotalPrice()+getTotalTax())"></div>
            </div>
            <br>
            <div class="flex text-xs font-semibold">
              <div class="flex-grow">MOTANTE PAGO</div>
              <div x-text="priceFormat(cash)"></div>
            </div>
            <hr class="my-2">
            <div class="flex text-xs font-semibold">
              <div class="flex-grow">TROCO</div>
        ...
        <div class="p-4 w-full">
          <button class="bg-cyan-500 text-white text-lg px-4 py-3 rounded-2xl w-full focus:outline-none" x-on:click="printAndProceed()">EMITIR RECIBO</button>
        </div>
      </div>
    </div>
  </div>
